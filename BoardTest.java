...
public class BoardTest {
    ...
    public void testConstructor() {
        ...
        assertEquals(1, b.getPointMult(6));
        assertEquals(5, b.getPointMult(7));
        assertEquals(1, b.getPointMult(8));
        assertEquals(1, b.getPointMult(9));
        assertEquals(1, b.getPointMult(10));
        assertEquals(3, b.getPointMult(11));
        assertEquals(1, b.getPointMult(12));
        assertEquals(2, b.getPointMult(13));
        assertEquals(1, b.getPointMult(14));
    ...
    //tests if multiplier array is correctly copied into the Board's pointMult array
    @Test
    ...
    public void testGetPointMultIllegalIndex() {
        ...
        assertEquals(7, b3.getPointMult(9));
